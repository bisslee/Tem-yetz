<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="recuperarSenha.aspx.cs" Inherits="YetzFlow.Web.recuperarSenha" %>
        ...
        <div class="container">
            <div class="card card-login mx-auto mt-5">
                ...
                <div class="card-body">
                    ...
                    <asp:Label ID="LblMensagemDeErro" CssClass="alert-danger" Visible="false" runat="server" Text=""></asp:Label>
                </div>
            </div>
        </div>
        <!-- Optional JavaScript -->
